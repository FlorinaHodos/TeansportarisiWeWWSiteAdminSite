    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="despre.php" class="active">Despre</a></li>
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Despre</h2>
              <p>Transportul terestru este cea mai răspândită formă de transport. Oamenii pot să se deplaseze prin propriile forțe sau cu ajutorul unor mijloace de transport ce folosesc forța umană, cum ar fi bicicleta, sau pot folosi tracțiunea animală, pentru a tracta căruțe sau alte tipuri de atelaje. Cea mai răspândită și eficientă formă de transport terestru folosește vehicule dotate cu motoare alimentate cu combustibil lichid.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="team" class="team pt-0">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="member">
              ...
              <div class="member-content">
                ...
                <p>
                Folosesc cele mai recente metode și principii de management pentru a asigura productivitatea maximă și pentru a îmbunătăți comunicarea.
                </p>
                <div class="social">
          ...
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="member">
              <img src="assets\img\team\team-2.jpg." class="img-fluid" alt="">
              <div class="member-content">
                <h4>Ioana Marcu</h4>
                <span>Tranport marfă</span>
                <p>
                Capacitatea de a respecta termenele limită, de a atinge obiectivele şi de a rezolva probleme esențiale pentru transport.
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6 d-flex">
            <div class="member">
              <img src="assets\img\team\team-3.jpg." class="img-fluid" alt="">
              <div class="member-content">
                <h4>Andrei Mihai</h4>
                <span>Inchiriază un autovehicul</span>
                <p>
                Prin seriozitate, profesionalism, punctualitate şi respect facem alegerea potrivită pentru fiecare client.
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
