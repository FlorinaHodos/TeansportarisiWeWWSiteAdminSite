...
?>
      ...
      <h2 class="text-center" style="padding-top: 120px;">Adăugare serviciu nou</h2>
      <section id="formular">
      <form action="formulare/adaugserviciu.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
            	...
            	<div class="col-sm-9 input-group mb-2">
            		<input type="text" class="form-control" name="titlu_serviciu" id="titlu_serviciu">
            	</div>
            </div>
            ...
            <div class="form-group row">
            	...
            	<div class="col-sm-9 input-group mb-2">
            		<textarea class="form-control" name="descriere_serviciu" id="descriere_serviciu" rows="5"></textarea>
            	</div>
            </div>
            ...
            <div class="form-group row">
            	...
            	<div class="col-sm-9 input-group mb-2">
            		<input type="text" class="form-control" name="titlu_detalii" id="titlu_detalii">
            	</div>
            </div>
            ...
            <div class="form-group row">
            	...
            	<div class="col-sm-9 input-group mb-2">
            		<textarea class="form-control" name="detalii" id="detalii" rows="5"></textarea>
            	</div>
            </div>
